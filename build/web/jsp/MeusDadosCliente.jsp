...
<html>
   ...
   <% 
       /*int id = 0;
            ...
            String mes=datanova.charAt(8)+""+datanova.charAt(9);
            String dia =datanova.charAt(5)+""+datanova.charAt(6);
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-4" id="data">
                            <div class="form-group " id="data">
                                ...
                                <input type="text" name="data" <% out.print("value='" + novo.getDtNascimento()+ "'"); %> class="form-control" id="inputData" readonly>
                            </div>
                        </div>
                    </div>
