...
<html>
    ...
    <body id="tudo">
        ...
        <div class="container">
            <h1 class="titulo">Termos e Condições Easy Pet</h1>
            <div id="texto">
                <p>
