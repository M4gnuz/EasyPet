        ...
        <div class="principal col-xs-12 col-sm-6 col-md-6">
            ...
            <table class="table" id="tabela_busca_meus_produtos">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td style='text-align: center'><img src="../ResourcesIm/cachorrinho.jpg" width='100px' height='80px'></td>
                        <td style='text-align: center'>1</td> 
                        <td style='text-align: center'>Boomer</td>
                        <td style='text-align: center'>Médio</td>
                        <td style='text-align: center'><i id="excluirProd" class="fas fa-trash-alt"></i></td>
                        <td style='text-align: center'><i id="editarProd" class="far fa-edit"></i></td>
                    </tr>
                </tbody>                
            </table>
